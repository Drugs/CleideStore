...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Out-2021 às 00:57
...
--
-- Banco de dados: `cleide_store_BETA`
--
...
INSERT INTO `cliente` (`id_cliente`, `nome_cliente`, `email_cliente`, `cpf_cliente`, `endereco_cliente`, `data_n_cliente`) VALUES
...
INSERT INTO `cupom` (`id_cupom`, `valor_cupom`, `codigo_cupom`, `d_limite_cupom`) VALUES
(1, 5, 'FIGMA1', '2021-11-10'),
(2, 5, 'TESTE1', '2021-09-24');
...
INSERT INTO `item_pedido` (`id_item_pedido`, `fk_id_produto`, `fk_id_pedido`, `quantidade_item`) VALUES
(1, 41, 1, 2),
(2, 42, 1, 2),
(3, 43, 1, 2),
(4, 44, 1, 2);
...
INSERT INTO `pedido` (`id_pedido`, `fk_id_cliente`, `fk_id_cupom`, `tipo_entrega`, `CEP_pedido`, `endereco_pedido`, `data_pedido`, `status_pedido`) VALUES
(1, 2, 0, 'entrega do ageu', '', '', '2021-09-15 20:49:08', 1),
(2, 4, 0, 'Correio - Caixa registrada', '', '', '2021-09-01 06:49:08', 4);
...
INSERT INTO `post` (`id_post`, `titulo_post`, `conteudo_post`, `data_post`, `autor_post`) VALUES
(1, 'tia creide', 'tia creide', '2021-09-01', 'tia creide'),
...
(41, 'Item 1', 'Lorem ipsum dolor', 55.25, '4', 4),
(42, 'Item 2', 'Lorem ipsum dolor sit', 44.91, '4', 5),
(43, 'Item 3', 'Descrição nova', 45.46, '3', 3),
...
INSERT INTO `suporte` (`id_suporte`, `fk_id_cliente`, `fk_id_pedido`, `data_suporte`, `status_suporte`, `informacoes_suporte`) VALUES
(2, 2, NULL, '2021-09-27 20:09:00', 'Aprovado', ''),
(46, 4, NULL, '2021-05-05 23:08:00', 'Aprovado', '');
...
ALTER TABLE `cliente`
  ...
  ADD UNIQUE KEY `cliente_email` (`email_cliente`),
  ADD KEY `cliente_nome` (`nome_cliente`);
...
--
ALTER TABLE `item_pedido`
  MODIFY `id_item_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `suporte`
  MODIFY `id_suporte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
